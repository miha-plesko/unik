...
udpServer.on('message', function (message, remote) {
	...
	console.log('ORIGINAL MESSAGE: ' + message.toString('ascii'));
	console.log('ORIGINAL MESSAGE: ' + message.toString('base64'));
	console.log('ORIGINAL MESSAGE: ' + message.toString('binary'));
	console.log('ORIGINAL MESSAGE: ' + message.toString('hex'));
	console.log('ORIGINAL MESSAGE: ' + message.toString('ucs2'));
